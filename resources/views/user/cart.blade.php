...
<section class=" py-8 antialiased dark:bg-gray-900 md:py-16">
  <div class="mx-auto max-w-screen-xl px-4 2xl:px-0">
    <h2 class="text-xl font-semibold text-gray-900 dark:text-white sm:text-xl judul">Shopping Cart</h2>
    ...
    <div class="mt-6 sm:mt-8 md:gap-6 lg:flex lg:items-start xl:gap-8">
      <div class="mx-auto w-full flex-none lg:max-w-2xl xl:max-w-4xl">
        <div class="space-y-6">
            ...
            <div
              ...
              <div class="space-y-4 md:flex md:items-center md:justify-between md:gap-6 md:space-y-0">
                ...
                <div class="text-end md:order-4 md:w-32">
                  <p class="text-base font-bold text-gray-900 dark:text-white">{{ $order->harga }}</p>
                </div>
          ...
          @empty
            <p class="text-lg font-medium text-gray-900 dark:text-white">Belum ada Barang yang dimasukkan ke keranjang</p>
          @endforelse
        </div>
      </div>
      ...
      <div class="mx-auto mt-6 max-w-4xl flex-1 space-y-6 lg:mt-0 lg:w-full">
        ...
        <div
          ...
          <form action="{{ route('checkout') }}" method="POST" class="flex w-full items-center justify-center">
            @csrf
            <button type="submit"
              class="rounded-lg bg-custom-pink px-5 py-2.5 text-sm font-medium text-white hover:bg-custom-pink/90 focus:outline-none focus:ring-4 focus:ring-custom-pink dark:bg-custom-pink dark:hover:bg-custom-pink/90 dark:focus:ring-custom-pink">
              Proceed to Checkout
            </button>
          </form>
          ...
          <div class="flex items-center justify-center gap-2">
            ...
            <a href="{{ route('go_shopping') }}" title=""
              class="inline-flex items-center gap-2 text-sm font-medium text-custom-pink underline hover:no-underline dark:text-custom-pink">
              Continue Shopping
